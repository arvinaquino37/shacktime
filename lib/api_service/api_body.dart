...
class BodyCheckIn {
  ...
  Future<Map<String, dynamic>> toJson() async{
    ...
    map['reason'] = _reason;
    map['qr_scan'] = _qrCode;
    map['check_in_image'] =_selfie != null ? await MultipartFile.fromFile(_selfie.toString(), filename: _selfie.toString()) : null;
    return map;
  }
}
...
class BodyCheckOut {
  ...
  Future<Map<String, dynamic>> toJson() async{
    ...
    map['country'] = _country;
    map['reason'] = _reason;
    map['check_out_image'] =_selfie != null ? await MultipartFile.fromFile(_selfie.toString(), filename: _selfie.toString()) : null;
    return map;
  }
}
