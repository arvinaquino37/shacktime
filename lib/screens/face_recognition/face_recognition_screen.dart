...
import 'package:hrm_app/screens/face_recognition/components/auth-action-button.dart';
import 'package:hrm_app/screens/face_recognition/components/camera_header.dart';
...
class FaceSignUpScreen extends StatefulWidget {
  const FaceSignUpScreen({Key? key}) : super(key: key);

  @override
  FaceSignUpScreenState createState() => FaceSignUpScreenState();
}

class FaceSignUpScreenState extends State<FaceSignUpScreen> {
  String? imagePath;
  Face? faceDetected;
  Size? imageSize;
      ...
      if (_cameraService.cameraController != null) {
        ...
        try {
          ...
          if (_faceDetectorService.faces.isNotEmpty) {
            ...
            setState(() { faceDetected = _faceDetectorService.faces.first; });
