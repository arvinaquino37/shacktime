...
import 'package:hrm_app/data/model/attendance_daily_report.dart';
import 'package:hrm_app/data/model/auth_response/response_verification_code.dart';
import 'package:hrm_app/data/model/notifications/read_notification.dart';
...
import 'package:hrm_app/data/model/response_approval_details.dart';
import 'package:hrm_app/data/model/response_approval_list.dart';
import 'package:hrm_app/data/model/response_approval_or_reject.dart';
import 'package:hrm_app/data/model/response_attendace_status.dart';
import 'package:hrm_app/data/model/response_attendance_report.dart';
...
import 'package:hrm_app/data/model/response_change_status.dart';
import 'package:hrm_app/data/model/response_check_in.dart';
import 'package:hrm_app/data/model/response_check_out.dart';
import 'package:hrm_app/data/model/response_clear_notification.dart';
import 'package:hrm_app/data/model/response_create_appreciate.dart';
import 'package:hrm_app/data/model/response_create_leave_request.dart';
import 'package:hrm_app/data/model/response_create_visit.dart';
import 'package:hrm_app/data/model/response_create_visit_note.dart';
import 'package:hrm_app/data/model/response_image_upload_visit.dart';
import 'package:hrm_app/data/model/response_leave_summary.dart';
...
import 'package:hrm_app/data/model/response_notice_create.dart';
import 'package:hrm_app/data/model/response_notice_details.dart';
import 'package:hrm_app/data/model/response_notice_list.dart';
import 'package:hrm_app/data/model/response_profile_image.dart';
import 'package:hrm_app/data/model/response_support_create.dart';
import 'package:hrm_app/data/model/response_support_details.dart';
import 'package:hrm_app/data/model/response_support_ticket_list.dart';
import 'package:hrm_app/data/model/response_user_search.dart';
import 'package:hrm_app/data/model/response_visit_details.dart';
import 'package:hrm_app/data/model/response_visit_history.dart';
...
class Repository {
  ...
  static Future<ApiResponse<ResponseCheckIn>> checkInApi(bodyCheckIn) async {
    try {
      EasyLoading.show(status: 'loading...');
      var response = await ApiService.getDio()!
  ...
  static Future<ApiResponse<ResponseCheckOut>> checkOutApi(
       bodyCheckOut, int? checkInID) async {
    // if (kDebugMode) {
